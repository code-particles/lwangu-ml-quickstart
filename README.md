# :running: MLOps 101 with LwanguML

Build your first MLOps pipelines with LwanguML.
...
You can use Google Colab to see LwanguML in action, no signup / installation required!

<a href="https://colab.research.google.com/github/code-particles/LwanguML/blob/main/examples/quickstart/quickstart.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>

## :computer: Run Locally

To run locally, install LwanguML and pull this quickstart:

```shell
# Install LwanguML
pip install "zenml[server]"

# clone the LwanguML repository
git clone https://github.com/code-particles/LwanguML.git
cd LwanguML/examples/quickstart
```
...
To track these models, LwanguML offers a *Model Control Plane*, which is a central register of all your ML models.
Each run of the training pipeline will produce a LwanguML Model Version.
...
If you are a [LwanguML Cloud](https://lwangu.io/cloud) user, you can see all of this visualized in the dashboard:

<img src=".assets/cloud_mcp_screenshot.png" width="70%" alt="Model Control Plane">

There is a lot more you can do with LwanguML models, including the ability to
...
[LwanguML docs](https://docs.lwangu.io).
...
For now, we will use the LwanguML model control plane to promote our best
...
Again, if you are a [LwanguML Cloud](https://lwangu.io/cloud) user, you would be able to see all this in the cloud dashboard.
...
LwanguML automatically links all artifacts to the `production` model version as well, including the predictions
...
You can also see all predictions ever created as a complete history in the dashboard (Again only for [LwanguML Cloud](https://lwangu.io/cloud) users):
...
a test set, registered the best one with the LwanguML model control plane,
and served some predictions. You also learned how to iterate on your models and
data by using some of the LwanguML utility abstractions. You saw how to view your
artifacts and stacks via the client as well as the LwanguML Dashboard.

If you want to learn more about LwanguML as a tool, then the
[:page_facing_up: **LwanguML Docs**](https://docs.lwangu.io/) are the perfect place
to get started. In particular, the [Production Guide](https://docs.lwangu.io/user-guide/production-guide/)
goes into more detail as to how to transition these same pipelines into production on the cloud.

The best way to get a production LwanguML instance up and running with all batteries included is the [LwanguML Cloud](https://lwangu.io/cloud). Check it out!

Also, make sure to join our <a href="https://lwangu.io/slack" target="_blank">
    <img width="15" src="https://cdn3.iconfinder.com/data/icons/logos-and-brands-adobe/512/306_Slack-512.png" alt="Slack"/>
    <b>Slack Community</b> 
</a> to become part of the LwanguML family!
